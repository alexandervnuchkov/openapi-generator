...
// Templates
import expandedEndpointTemplate from '~/templates/expanded-endpoint-template-list';
import focusedEndpointTemplate from '~/templates/focused-endpoint-template';
import overviewTemplate from '~/templates/overview-template-list';
import endpointTemplate from '~/templates/endpoint-template';
import headerTemplate from '~/templates/header-template';
import navbarTemplate from '~/templates/navbar-template-list';
...
export default function mainBodyTemplate(isMini = false, showExpandCollapse = true, showTags = true, pathsExpanded = false) {
  ...
  return html`
    ...
    <div id='the-main-body' class="body ${this.cssClasses} ${this.allowTry === 'true' ? 'allow-try' : ''}" dir= ${this.pageDirection} >
      <!-- Side Nav -->
